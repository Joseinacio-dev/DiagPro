...
function SupportPage({ startupStatus, device, scanSession, onOpenDiagIa }) {
  ...
  return <section className="support-page" aria-labelledby="support-title">
    ...
    <div className="support-grid">
      ...
      <article className="support-card support-human-card"><div className="support-card-icon"><Headphones size={21} /></div><div className="support-card-copy"><h2>Suporte humano</h2><p>Chamados autenticados ficam vinculados à sua conta. Atendimento instantâneo por chat ainda não está disponível.</p></div><div className="support-human-actions"><button type="button" onClick={() => document.getElementById('support-tickets')?.scrollIntoView({ behavior: 'smooth' })}><Wrench size={15} />Abrir chamado</button><button type="button" disabled><MessageCircle size={15} />Chat ao vivo <small>Indisponível</small></button></div></article>
    </div>
